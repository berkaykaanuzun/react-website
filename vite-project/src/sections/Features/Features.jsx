  ...
  return (
    <>
      <div className="container">
        <div className="row">
          <Card icon={feature1.icon} title={feature1.title} text={feature1.text}/>
          <Card icon={feature2.icon} title={feature2.title} text={feature2.text}/>
          <Card icon={feature3.icon} title={feature3.title} text={feature3.text}/>
          <Card icon={feature4.icon} title={feature4.title} text={feature4.text}/>
          <Card icon={feature5.icon} title={feature5.title} text={feature5.text}/>
          <Card icon={feature6.icon} title={feature6.title} text={feature6.text}/>
        </div>
      </div>
    </>
  );
